...
export const DataStructureParser: React.FC<ParserProps> = ({
  ...
  return (
    <div className="grid grid-cols-2 gap-4 p-6 h-[calc(100vh-8rem)] max-w-[1600px] mx-auto">
      {/* Input Panel */}
      <div className="flex flex-col h-full">
        ...
        <textarea
          ...
          placeholder="Paste your data here... (JSON or XML)"
        />
      </div>
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 relative">
          {error ? (
            ...
            <div className="h-full p-4 bg-gray-50 border border-gray-200 rounded-lg overflow-auto">
